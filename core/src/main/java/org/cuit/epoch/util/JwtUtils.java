...
public class JwtUtils {
     ...
     * jwt 加密解密密钥(可自行填写)
     */
    private static final String JWT_SECRET = "afafaqw1231kwsamflsamlaoiwj4121312l4m21l5mlbncflasnflasjfoia";
    ...
    public static void main(String[] args) {
        ...
        // 验证
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMTEiLCJvcGVuSWQiOiIxMTEiLCJ1c2VySWQiOjIwLCJqdGkiOiJ0b2tlbklkIiwiaWF0IjoxNjQyNjA0NTk4LCJleHAiOjE2NDI2MDcxOTB9.XCS0gJy9L7qThgxgoKTF8CV-VDoC8p1-NJp5lH3auKM";
